...
export function ReaderAccount({ locale = "en" }: { locale?: Locale }) {
  ...
  async function changePassword(event: React.FormEvent) {
    ...
    try {
      await api.changeReaderPassword(profile?.hasPassword ? currentPassword : undefined, newPassword);
